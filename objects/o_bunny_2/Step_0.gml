...
var h_input = o_input.right_key_2 - o_input.left_key_2;
...
{	
	...
	if (alarm[2]> 0  && o_input.jump_key_2)
	{
...
if(combat_ == true)
{
	if(o_game.target == "A")
	{
		...
		else if(gamepad_button_check_pressed(1,gp_face2) || gamepad_button_check_pressed(1,gp_face3) || gamepad_button_check_pressed(1,gp_face4))
		{
			combat_points -= 1;
		}
	}
	else if(o_game.target == "X")
	{
		...
		else if(gamepad_button_check_pressed(1,gp_face2) || gamepad_button_check_pressed(1,gp_face1) || gamepad_button_check_pressed(1,gp_face4))
		{
			combat_points -= 1;
		}
	}
	else if(o_game.target == "Y")
	{
		...
		else if(gamepad_button_check_pressed(1,gp_face2) || gamepad_button_check_pressed(1,gp_face3) || gamepad_button_check_pressed(1,gp_face1))
		{
			combat_points -= 1;
		}
	}
	else if(o_game.target == "B")
	{
		...
		else if(gamepad_button_check_pressed(1,gp_face1) || gamepad_button_check_pressed(1,gp_face3) || gamepad_button_check_pressed(1,gp_face4))
		{
			combat_points -= 1;
		}
	}
